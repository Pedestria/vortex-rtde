...
exports.FindModulesAndDependencies = void 0;
const fs = require("fs");
const Babel = require("@babel/parser");
function FindModulesAndDependencies(entry) {
...
exports.FindModulesAndDependencies = FindModulesAndDependencies;
function resolveDependencies(deps, loc) {
    let resolvedDeps = [];
    let paths = [];
